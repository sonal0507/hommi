...
// Emergency force functions for debugging
function forceStep2() {
    console.log('Force Step 2 called');
    if (!currentProject) currentProject = {};
    currentProject.homeType = 'villa';
    currentProject.bedrooms = '3';
    currentProject.squareFeet = '1500-2000';
    currentProject.bathrooms = '2';
    currentProject.location = 'Mumbai';
    saveProjectData();
    showScreen('home-details-step3');
    showToast('Forced navigation to Step 3');
}

function testStep2Form() {
    console.log('Testing Step 2 form');
    const form = document.querySelector('#home-details-step2 form');
    if (form) {
...
window.forceStep2 = forceStep2;
window.testStep2Form = testStep2Form;